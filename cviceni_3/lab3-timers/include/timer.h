...
#define TIM_STOP    TCCR0B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00));

#define TIM_OVF_16U    TCCR0B &= ~((1<<CS02) | (1<<CS01)); TCCR0B |= (1<<CS00);
#define TIM_OVF_128U   TCCR0B &= ~((1<<CS02) | (1<<CS00)); TCCR0B |= (1<<CS01);
#define TIM_OVF_1MS    TCCR0B &= ~(1<<CS02); TCCR0B |= (1<<CS01); TCCR0B |= (1<<CS00);
#define TIM_OVF_4MS    TCCR0B &= ~((1<<CS01) | (1<<CS00)); TCCR0B |= (1<<CS02);
#define TIM_OVF_16MS   TCCR0b &= ~(1<<CS01); TCCR0B |= (1<<CS02); TCCR0B |=(1<<CS00);
...
#define TIM_OVF_ENABLE  TIMSK0 |= (1<<TOIE0);
#define TIM_OVF_DISABLE TIMSK1 &= ~(1<<TOIE0);
